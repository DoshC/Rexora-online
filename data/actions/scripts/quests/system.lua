...
local hotaQuest = {12101,12102, 12103, 12104, 12105, 12106, 12107}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if isInArray(hotaQuest, item.uid) then
		if getPlayerStorageValue(cid,TheAncientTombs.DefaultStart) ~= 1 then
			setPlayerStorageValue(cid,TheAncientTombs.DefaultStart, 1)
		end
	end
	return true
end
