...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'task') then
		...
		elseif getPlayerStorageValue(cid, 14103) == 2 then
			npcHandler:say("So you had the guts to enter that room. Well, it\'s all fake magic anyway and no real threat. ...', 'What are you looking at me for? Waiting for something? I told you that there was no reward. Despite being allowed to stand before me without being squashed like a bug. Get out of my sight!", cid)
