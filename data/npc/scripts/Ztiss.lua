...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "offer") then
		if getPlayerStorageValue(cid,TheNewFrontier.Questline) == 23 then
	...
	elseif msgcontains(msg, "work") then
		if TopicState[cid] == 1 then
			...
			addEvent(selfSay, 6000,	"One of ziz warriorz could be you. Or you could ztay here and rot in ze dungeon. Are you interezted in ziz deal? ", cid)
			TopicState[cid] = 2
		end
	elseif msgcontains(msg, "yes") then
		if TopicState[cid] == 2 then
			...
			addEvent(selfSay, 3000,	"Zo are you ready to drink ziz poizon here? ", cid)
			TopicState[cid] = 3
		elseif TopicState[cid] == 3 then
			...
			addEvent(selfSay, 3000,	"Zere you'll learn anyzing you need to know about ze great tournament. ", cid)
			setPlayerStorageValue(cid,TheNewFrontier.Questline, 24)
			setPlayerStorageValue(cid,TheNewFrontier.Mission07, 3) --Questlog, The New Frontier Quest "Mission 07: Messengers Of Peace"
			setPlayerStorageValue(cid,TheNewFrontier.Mission08, 1) --Questlog, The New Frontier Quest "Mission 08: An Offer You Can't Refuse"
			TopicState[cid] = 0
		end
	end
	return true
