...
function greetCallback(cid)
	if(getPlayerStorageValue(cid, STORAGE_DRAGON) < 1) then
...
function creatureSayCallback(cid, type, msg)
	...
	if(getPlayerStorageValue(cid, STORAGE_DRAGON) < 1) then
		if(msg == "SOLOSARASATIQUARIUM") then
			...
			npcHandler:say("The hole grows larger, you cannot close your eyes. An unimaginable black. Deeper and darker than any nothingness you could possibly imagine drags you into it. ..." , cid, true)
			npcHandler:say("You feel as if you cannot breathe anymore. The very second you let loose of your consciousness, you sense all heaviness around you lifted. ..." , cid, true)
			npcHandler:say("You dive into an ocean of emerald light. Feeling like born anew the colour around you is almost overwhelming. Countless objects of all shapes and sizes are dashing past you. Racing against each other, millions are clashing in the distance. .." , cid, true)
			npcHandler:say("The loudness of the gargantuan spectacle around you bursts your hearing, yet you absorb all the sounds around you. ..." , cid, true)
			npcHandler:say("As several large obstacles move aside directly in front of you, an intense bright centre leaps into your view. Though you cannot perceive how fast you are, your pace seems too slow. ..." , cid, true)
			npcHandler:say("Ever decelerating, you ultimately approach a middle in this chaos of tones of green. ..." , cid, true)
			npcHandler:say("As you come closer to it, yellowish shades of orange embrace you, softer shapes emerge and you almost forget the mayhem before. In warm comfort you see what lies in the heart of it all. ..." , cid, true)
			npcHandler:say("A majestic dragon in his sleep is surrounded by what seems the warmth and energy of a thousand suns. The tranquillity of its sight makes you smile gently. ..." , cid, true)
			npcHandler:say("You feel a perfect mixture of joy, compassion and sudden peacefulness. Bright xanthous impressions of topaz, orange and white welcome you at the final halt of your journey. ..." , cid, true)
			npcHandler:say("Dragon dreams are golden. ..." , cid)
			npcHandler:say("You find yourself inside the dragon's dream. You can look around or go into a specific direction. You can also take or use an object. Enter help to display this information at any time.", cid, true)
		...
		elseif(string.lower(msg) == "use attachment" and talkState[talkUser] == 14) then
			...
			npcHandler:say("As your eyes adjust to the sudden reduction of brightness, you see the giant wings of the gate before you move to the side. You can also make out something shiny on the ground.", cid, true)
		...
		elseif(string.lower(msg) == "north" and talkState[talkUser] == 16) then
			...
			npcHandler:say("The rustling gets louder until you come to a small dune. Behind it you find the source of the noise. ", cid, true)
		...
		elseif(string.lower(msg) == "use model" and talkState[talkUser] == 17) then
			...
			npcHandler:say("The very moment you walk down the dune to head back south, rays of light burst over your head in a shock wave that makes you tumble down the rest of the hill. ... ", cid, true)
			npcHandler:say("You can also hear a deep loud scraping for several minutes somewhere far in the west. ", cid, true)
		...
		elseif(string.lower(msg) == "use mirror" and talkState[talkUser] == 33) then
			...
			setPlayerStorageValue(cid, STORAGE_DRAGON, 1)
		end
	elseif(getPlayerStorageValue(cid, STORAGE_DRAGON) == 1) then
		...
		elseif(msgcontains(msg, "mission") and talkState[talkUser] == 1) then
			...
			npcHandler:say("This procedure may be exhausting. Are you prepared to receive my key?", cid, true)
			talkState[talkUser] = 2
		elseif(msgcontains(msg, "yes") and talkState[talkUser] == 2) then
			npcHandler:say("SAETHELON TORILUN GARNUM. ... ", cid)
			npcHandler:say("SLEEP. ...", cid, true)
			npcHandler:say("GAIN. ...", cid, true)
			npcHandler:say("RISE. ...", cid, true)
			npcHandler:say("The transfer was successful. ...", cid, true)
			npcHandler:say("You are now prepared to enter the realm of the evildoer. I am grateful for your help, wayfarer. Should you seek my council, use this charm I cede to you. For my spirit will guide you wherever you are. May you enjoy a sheltered future, you shall prevail.", cid, true)
			setPlayerStorageValue(cid, STORAGE_DRAGON, 2)
