...
local function greetCallback(cid)
	...
	if getPlayerStorageValue(cid,OutfitQuest.MageSummonerWandAddon) < 1 then
	...
	elseif	getPlayerStorageValue(cid,OutfitQuest.MageSummonerWandAddon) >= 1 then
