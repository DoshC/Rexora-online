ownerName = ""
	...
	motd = "Welcome to the OTX Emporia!"
	serverName = "The OTX Emporia"
	loginMessage = "Welcome to The OTX Emporia!"
	...
	displayCriticalHitNotify = false removeWeaponAmmunition = false
